...
//         target3CopyContractFactory = new ethers.ContractFactory(abi, bytecode, deployer);
...
//         iTarget3Copy = await ethers.getContractAt("ITarget3", deployer);
//       });
