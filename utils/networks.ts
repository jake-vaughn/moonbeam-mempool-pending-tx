...
export function accounts(networkName?: string): { mnemonic: string; count: number; path: string } {
  return { mnemonic: getMnemonic(networkName), count: 140, path: "m/44'/60'/0'/0" }
}
